...
const TACTICS_DB = [
  { id:1, name:'Tiki-Taka Total',       formation:'4-3-3',   formOOP:'4-5-1',   style:'Possession', score:9.2, votes:1847, author:'TacticoMaster', tags:['DLP','Half Back','Ball-Playing CB'], ip:'Possession dominante avec circuits courts. Ball-Playing GK + DLP + Half Back pour construire.', oop:'Bloc intermédiaire compact. Pressing structuré sur les flancs.' },
  { id:2, name:'Gegenpress Engine',      formation:'4-2-3-1', formOOP:'4-2-3-1', style:'Gegenpress', score:9.1, votes:1523, author:'PressingKing',   tags:['B2B','False 9','Pressing CM'], ip:'Double DM Box-to-Box + False 9 pour perturber la défense adverse.', oop:'Pressing haut coordonné. Tracking CF + Pressing CM + Pressing DM.' },
  ...
  { id:4, name:'High Line Blitz',        formation:'3-4-3',   formOOP:'3-4-3',   style:'High Press', score:8.9, votes:987,  author:'HighLineHero',  tags:['Sweeper Keeper','WB','Pressing DM'], ip:'3 CBs avec WBs offensifs. Sweeper Keeper derrière la ligne haute.', oop:'Pressing WBs + Pressing DM pour fermer les espaces latéraux.' },
  { id:5, name:'Low Block Counter',      formation:'5-4-1',   formOOP:'5-4-1',   style:'Counter',    score:8.7, votes:876,  author:'CounterKing',   tags:['Central Outlet CF','Wide Outlet Mid','Holding WB'], ip:'5-4-1 discipliné. Central Outlet CF + Wide Outlet Mids pour les transitions rapides.', oop:'Bloc bas très compact. Holding WBs pour sécuriser les flancs.' },
  { id:6, name:'Direct Power Play',      formation:'4-4-2',   formOOP:'4-5-1',   style:'Direct',     score:8.4, votes:743,  author:'DirectFootball', tags:['Target Forward','Wide Mid','Stopping CB'], ip:'Double ST avec Target Forward. Wide Mids qui centrent tôt pour les duels aériens.', oop:'Milieu à 5 défensif. Tracking Wide Mids + Screening DM.' },
  { id:7, name:'Asymetric Press',        formation:'4-3-3',   formOOP:'4-2-3-1', style:'Gegenpress', score:8.3, votes:612,  author:'AsymFM',        tags:['Inside Forward','Playmaking WB','B2B Playmaker'], ip:'Asymétrie: Inside Forward côté gauche, Winger côté droit. Playmaking WB pour créer.', oop:'Double DM avec Pressing et Screening pour protéger la contre.' },
  { id:8, name:'3-5-2 Domination',       formation:'3-5-2',   formOOP:'5-3-2',   style:'Possession', score:8.1, votes:534,  author:'ThreeCBFan',    tags:['Overlapping CB','Box-to-Box','Target Forward'], ip:'Overlapping CBs pour la largeur. Double ST avec jeu de combinaisons.', oop:'5-3-2 avec WBs défensifs. CBs couvrants.' },
]
